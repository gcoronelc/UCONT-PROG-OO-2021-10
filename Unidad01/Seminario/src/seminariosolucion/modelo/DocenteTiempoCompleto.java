...
public class DocenteTiempoCompleto extends Docente{
	...
	public DocenteTiempoCompleto(String grado, boolean investiga, int codigo, String nombre, String apellido, String dni, String correo, String teléfono, double sueldoBase, double sueldoExtra, double sueldoNeto) {
